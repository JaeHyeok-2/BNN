...
if __name__ == "__main__":
    ...
    # train_model(net, dataloader=train_loader, num_epochs= cfg["train"]["epoch_num"])
    train_and_evaluate(net, train_loader=train_loader, val_loader= val_loader, num_epochs=cfg['train']['epoch_num'])
